  ...
  <div className="relative container mx-auto px-4">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="flex flex-col items-center text-center p-4">
        ...
        <p className="text-gray-800">Todos nuestros vehículos están verificados y con garantía.</p>
      </div>
      ...
      <div className="flex flex-col items-center text-center p-4">
        ...
        <p className="text-gray-800">Opciones de financiación adaptadas a tus necesidades.</p>
      </div>
      ...
      <div className="flex flex-col items-center text-center p-4">
        ...
        <p className="text-gray-800">Servicio personalizado antes, durante y después de la compra.</p>
      </div>
    </div>
  </div>
</div>
