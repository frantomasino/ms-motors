  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
        <DialogContent
          // Flex para centrar modal en pantalla (vertical y horizontal)
          className="flex items-center justify-center p-0"
          // Sin scroll aquí, lo manejamos adentro
        >
          {/* Contenedor principal del modal: tamaño fijo y borde */}
          <div className="relative bg-white rounded-lg shadow-lg w-full max-w-3xl max-h-[90vh] flex flex-col">
            {/* Header fijo arriba */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white z-50">
              <div>
            ...
            <div
              className="overflow-y-auto px-6 py-4 flex-1 grid md:grid-cols-2 gap-6"
              style={{ WebkitOverflowScrolling: "touch" }} // para mejor scroll móvil
            >
              {/* Galería */}
