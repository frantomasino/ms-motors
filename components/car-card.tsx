    ...
    <article className="group flex flex-col bg-white rounded-2xl overflow-hidden border border-gray-100/90 shadow-[0_1px_2px_rgba(16,24,40,0.04)] hover:shadow-[0_18px_44px_rgba(16,24,40,0.12)] hover:-translate-y-1 transition-all duration-300">
        ...
        {count > 1 && (
          <>
            <button
              ...
              className="absolute left-2 top-1/2 z-10 -translate-y-1/2 h-10 w-10 sm:h-8 sm:w-8 rounded-full bg-black/55 hover:bg-black/75 text-white flex items-center justify-center"
            >
            ...
            <button
              ...
              onClick={(e) => onArrow(e, 1)}
              className="absolute right-2 top-1/2 z-10 -translate-y-1/2 h-10 w-10 sm:h-8 sm:w-8 rounded-full bg-black/55 hover:bg-black/75 text-white flex items-center justify-center"
            >
      ...
      <div className="flex flex-col flex-1 p-4 gap-3">
        <Link href={`/autos/${slug}`} className="block">
          ...
          <h3 className="font-title text-[1.25rem] sm:text-[1.35rem] text-ink leading-tight mt-0.5 group-hover:text-brand transition-colors">
            {car.model}
          </h3>
