...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-[#0c0e12] flex flex-col items-center justify-center px-6 text-center">
      ...
      <p className="text-red-500 text-sm font-semibold uppercase tracking-widest mb-3">Error 404</p>
      <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Página no encontrada</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <Link href="/#catalog"
          className="flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-full transition-all hover:scale-[1.02] text-sm">
          Ver catálogo
        </Link>
